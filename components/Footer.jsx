    ...
    const linkSections = [
        {
            title: "PRODUCTS",
            links: [
                { text: "Dryfruits", path: '/', icon: null },
                { text: "Seeds", path: '/', icon: null },
                { text: "Combo", path: '/', icon: null },
            ]
        },
        {
            title: "WEBSITE?",
        ...
        },
        {
            title: "CONTACT",
            links: [
                { text: "+91-7014000427", path: '/', icon: MailIcon },
                { text: "lalitamangal049@gmail.com", path: '/', icon: PhoneIcon },
                { text: "36, Raj Nagar-A, Bajaria, Sawai Madhopur", path: '/', icon: MapPinIcon }
            ]
        }
    ];
            ...
            <div className="max-w-7xl mx-auto">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm">Welcome to mangal superfoods, your ultimate destination for healthy and nutritious servings, we bring you the best quality — all in one place.</p>
                ...
                <p className="py-4 text-sm text-slate-500">
                    Copyright 2025 © Mangal Superfoods All Right Reserved.
                </p>
            </div>
        </footer>
    );
